...
const ProfileSection = ({ username, handleLogout }) => {
    ...
    const handleFileUpload = (e) => {
        ...
        reader.onload = async (evt) => {
            ...
            if (result_text.includes(`"chatmessages":[`) && result_text.includes(`"chatflows":[`) && result_text.includes(`"apikeys":[`)) {
                dispatch({ type: SET_MENU, opened: false })
                setLoading(true)

                try {
                    await databaseApi.createLoadDatabase(JSON.parse(result_text))
                    setLoading(false)
